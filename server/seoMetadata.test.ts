...
const seoMeta = readFileSync(new URL("../client/src/components/SeoMeta.tsx", import.meta.url), "utf8");
...
describe("SEO metadata", () => {
  it("uses the approved concise official title in every sharing surface", () => {
    ...
    expect(seoMeta).toContain('title: "Cavidan Fatihi — Official Website"');
    expect(seoMeta).not.toContain("Azərbaycanlı Müğənni");
  });
});
