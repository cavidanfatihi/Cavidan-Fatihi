...
export function AboutPage() {
  ...
  const paragraphs = locale === "az" ? ["Cavidan Fatihi 30 iyul 1994-cü ildə Yevlax şəhərində anadan olmuşdur. 2000-ci ildə Yevlax şəhər Vüqar Əmiraslanov adına 2 sayılı orta məktəbdə təhsil aldıqdan sonra, 2011-ci ildə Mingəçevir Özəl Türk Liseyindən məzun olmuşdur.", "Uşaqlıqdan musiqiyə həvəsi olan Cavidan Fatihi fortepiano təhsili almış, həm məktəb, həm də liseyin əksər tədbirlərində və beynəlxalq yarışmalarda fəal çıxış etmişdir. 2011-ci ildə Milli Aviasiya Akademiyasının Hüquqşünaslıq fakültəsinə qəbul olmuş və 2015-ci ildə məzun olmuşdur.", "2012-ci ildə onlayn gitara dərsləri aldıqdan sonra yenidən musiqi ilə yolları birləşmişdir. Professional musiqi karyerasına 2018-ci ildə “Sənsiz” mahnısı ilə başlamışdır. Cavidan Fatihi həm öz bəstələrini, həm də bir çox xalq və bəstəkar mahnılarının coverlərini dinləyicilərinə təqdim etmişdir."] : ["Cavidan Fatihi was born in Yevlakh on 30 July 1994. He began his education at School No. 2 named after Vugar Amiraslanov in Yevlakh in 2000, and graduated from Mingachevir Private Turkish Lyceum in 2011.", "Drawn to music from an early age, he studied piano and performed actively at school and lyceum events, as well as international competitions. In 2011, he entered the Faculty of Law at the National Aviation Academy and graduated in 2015.", "After taking online guitar lessons in 2012, his path reconnected with music. He began his professional career with the song “Sənsiz” in 2018. Alongside his own compositions, Cavidan Fatihi shares interpretations of folk songs and works by prominent composers with his audience."];
